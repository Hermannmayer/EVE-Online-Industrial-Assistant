...
# ════════════════════════════════════════════════════════════════
#  评分缓存 — 基于 TtlLRUCache（自 test_scoring_cache 并入）
# ════════════════════════════════════════════════════════════════
...
def _patch_module_stubs(stubs: dict):
...
def test_trade_score_caches_result():
    ...
    db = sqlite3.connect(":memory:")
    db.executescript("CREATE TABLE item (type_id INTEGER PRIMARY KEY, volume REAL);")
    ...
    _patch_module_stubs({"get_price": _stub_get_price, "get_volume": _stub_get_volume})
