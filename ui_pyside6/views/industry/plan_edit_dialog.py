...
class PlanEditDialog(QDialog):
    ...
    def _on_theme_changed(self):
        self.setStyleSheet(
            ...
            f"QCheckBox {{ color: {theme.TEXT_PRIMARY}; background: transparent; font-size: {theme.fs(12)}px; }}"
            f"QSpinBox, QComboBox, QLineEdit, QTextEdit {{"
            f"  padding: 4px 8px; border: 1px solid {theme.BORDER}; border-radius: 4px;"
            f"  background: {theme.BG_SURFACE}; color: {theme.TEXT_PRIMARY}; font-size: {theme.fs(12)}px;"
            f"}}"
