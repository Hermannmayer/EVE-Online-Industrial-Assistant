...
```python
def can_force_start(plan: dict, mat_hangar_id: int | None, all_plans: list[dict], *, shortfall_count: int, bp_short: str | None=None, blueprint_ready: bool | None=None) -> bool
```
