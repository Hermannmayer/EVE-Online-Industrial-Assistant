...
```python
def calc_refining_yield(skills: dict | None=None, *, is_player_facility: bool=False, station_base: float | None=None, implant_bonus: float=0.0, ore_skill_level: int=0) -> float
```
